...
def value():
    ...
    d=len(b2)
    if(s.get()==""):
        Label(root,text="Name*",fg="red",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=150,y=80)
    else:
        o=1
        Label(root,text="Name",fg="Black",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=150,y=80)
    if(c==10):
        Label(root,text="Phone",fg="Black",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=150,y=130)
        n=1
    else:
        Label(root,text="Phone*(10 digit)",fg="red",bg="Light blue",font=("Arial Rounded MT Bold",12)).place(x=190,y=130)
    if(d==4):
        Label(root,text="Password",fg="Black",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=150,y=180)
        m=1
    else:
...
def test():
    ...
    if(c==4):
            ...
            Label(root,text="Please Enter Password",fg="BLack",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=170,y=130)
             ...
             Label(root,text="Please Enter Password*",fg="red",bg="Light blue",font=("Arial Rounded MT Bold",12)).place(x=167,y=130)
    if(d==4):
                m=1
                Label(root,text="Please Enter Account Number",fg="BLack",bg="Light blue",font=("Arial Rounded MT Bold",12),width=25).place(x=145,y=80)
    else:
            Label(root,text="Please Enter Account Number*",fg="red",bg="Light blue",font=("Arial Rounded MT Bold",12)).place(x=142,y=80)
    if(n==1 and m==1):
            check()
...
def change():
    ...
    if(len(a)==4):
        n=1
        Label(root,text="Account Number",fg="Black",bg="Light blue",font=("Arial Rounded MT Bold",12),width=20).place(x=150,y=180)
    else:
...
def wit2():
    ...
    if(100<=wth.get()<=10000):
        if(wth.get()<=amt):
            amt=amt-wth.get()
            up()
            Label(root,text="Withdraw successful",fg="red2",bg="Light blue",width=20,height=2,font=("Arial Rounded MT Bold",12)).place(x=165,y=260)
        else:
...
def add():
    ...
    if(100<=wth.get()<=100000):
        amt=amt+wth.get()
        up()
        Label(root,text="Deposit successful",fg="red",bg="Light blue",width=20,height=2,font=("Arial Rounded MT Bold",12)).place(x=165,y=260)
    else:
...
def tran():
            ...
            canvas = Canvas(root, width=500, height=450, bd=0, highlightthickness=0, highlightbackground="yellow", bg="Light blue")
            canvas.place(x=0,y=0)
            Label(root,text="TRANSACTION  PAGE",fg="navy",bg="Light blue",font=("Cooper BLack" ,20)).place(x=120,y=20)
